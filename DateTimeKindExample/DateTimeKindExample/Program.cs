...
namespace DateTimeKindExample
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("\nd4 To String: " + d4.ToString("yyyy-MM-ddTHH-mm-ssZ")); //perigo
            Console.WriteLine("4 To Universal Time and To String: " + d4.ToUniversalTime().ToString("yyyy-MM-ddTHH-mm-ssZ"));
